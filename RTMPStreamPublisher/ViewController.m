...
-(void)viewDidLoad {
    ...
    //hostTextField.text = @"rtmp://ec2-54-228-65-3.eu-west-1.compute.amazonaws.com:1935/eyetok-live"; // wowza
    //hostTextField.text = @"rtmp://wysiwis.studec.fr:1935/assistance"; // red5
