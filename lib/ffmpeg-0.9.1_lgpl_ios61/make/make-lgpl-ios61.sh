#  FILE: make-lgpl-ios61.sh
#
#  FFmpeg LGPL ( --disable-gpl ) - iOS SDK 6.1 compilation script for armv7s, armv7 & i386 architectures
#
#  Created by Vyacheslav Vdovichenko on 08/28/13.
#  Copyright 2012 The Midnight Coders, Inc. All rights reserved.
#
###############################################################
# 1. download FFmpeg from http://ffmpeg.org/download.html     #
# 2. copy make-lgpl-ios61.sh to ./FFmpeg                      #
# 3. cd ./FFmpeg && run ./make-lgpl-ios61.sh                  #
###############################################################
...
./configure --prefix=compiled/armv7s --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk/usr/lib/system --disable-bzlib --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-cross-compile --arch=arm --target-os=darwin --cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk --cpu=cortex-a8 --extra-cflags='-arch armv7s' --extra-ldflags='-arch armv7s' --extra-cflags=-I/usr/local/include --enable-pic --disable-asm
...
./configure --prefix=compiled/armv7 --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk/usr/lib/system --disable-bzlib --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-cross-compile --arch=arm --target-os=darwin --cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk --cpu=cortex-a8 --extra-cflags='-arch armv7' --extra-ldflags='-arch armv7' --extra-cflags=-I/usr/local/include --enable-pic --disable-asm
...
./configure --prefix=compiled/i386 --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk/usr/lib/system --disable-bzlib --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-cross-compile --arch=i386 --target-os=darwin --cc=/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk --cpu=i386 --extra-cflags='-arch i386' --extra-ldflags='-arch i386' --extra-cflags=-I/usr/local/include --enable-pic --disable-asm
...
./compiled/lipo -output ./compiled/fat/lib/libswresample.a -create \
