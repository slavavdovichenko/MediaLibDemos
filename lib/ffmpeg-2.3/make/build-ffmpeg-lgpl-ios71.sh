#  FILE: build-ffmpeg-lgpl-ios71.sh
#
#  ffmpeg LGPL ( --disable-gpl ) - iOS SDK 7.1 build script for arm64, armv7s, armv7, x86_64, i386 architectures
#
#  Created by Vyacheslav Vdovichenko on 07/04/14.
#  Copyright 2014 The Midnight Coders, Inc. All rights reserved.
#
##############################################################
# 1. download ffmpeg from http://ffmpeg.org/download.html    #
# 2. copy build-ffmpeg-lgpl-ios71.sh to ./ffmpeg             #
# 3. cd ./ffmpeg && ./build-ffmpeg-lgpl-ios71.sh             #
##############################################################
...
./build/lipo -output ./build/fat/lib/libswresample.a -create \
-arch arm64 ./build/arm64/lib/libswresample.a \
-arch armv7s ./build/armv7s/lib/libswresample.a \
-arch armv7 ./build/armv7/lib/libswresample.a \
-arch x86_64 ./build/x86_64/lib/libswresample.a \
-arch i386 ./build/i386/lib/libswresample.a
